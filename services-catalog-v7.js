window.BDJ_SERVICES = [
  ...
  {category:'Cortes e combos',name:'Corte + Barba na navalha com toalha quente',description:'Corte de cabelo aliado ao ritual de barba com toalha quente, navalha e acabamento caprichado.',price:80,duration:60},
  ...
  {category:'Barba',name:'Barba na navalha com toalha quente',description:'Ritual de barba completo com toalha quente, espuma, acabamento na navalha e produtos profissionais.',price:40,duration:30},
  ...
  {category:'Pigmentações',name:'Aplicação de Fibra Capilar',description:'Preenchimento capilar imediato para disfarçar falhas e áreas rarefeitas, aplicado e finalizado no acabamento do corte. Resultado natural, resiste ao vento e sai na próxima lavagem.',price:30,duration:15},
