...
export function makeFixtures(overrides = {}) {
  const tables = {
    ...
    bookings: [
      ...
      // v29.152.0 (caso Helder): a ficha da Carla tem 13 dígitos (55 + DDD + 9 + 8); este
      // agendamento tem o MESMO número com 11. Tem que continuar sendo UMA Carla no painel.
      booking({ customer_name: CARLA.name, customer_phone: '11955554444', customer_email: null, status: 'confirmed', booking_date: iso(addDays(today, 3)), start_time: '10:00:00', end_time: '10:30:00' }),
    ...
    content_posts: [
      { id: 'mock-cp-1', platform: 'whatsapp_business', caption: '📅 Abriu um horário hoje às 14:00! Chama pra garantir o seu.', background_color: null, status: 'rascunho', source: 'ia', context: { tipo: 'vaga_aberta', data: dayOfMonth(9), horarios_livres: 3, primeiro_horario: '14:00', image_url: '/assets/promo-guia-barba-status.jpg' }, created_at: tsOfMonth(9, 8), updated_at: tsOfMonth(9, 8), approved_at: null, published_at: null, evolution_message_id: null },
      { id: 'mock-cp-2', platform: 'whatsapp_business', caption: '✂️ Hoje em destaque: Barboterapia por R$40,00. Agenda pelos próximos dias!', background_color: null, status: 'publicado', source: 'ia', context: { tipo: 'servico_destaque', servico: 'Barboterapia', preco: 40, duracao_minutos: 30 }, created_at: tsOfMonth(5, 8), updated_at: tsOfMonth(5, 9), approved_at: tsOfMonth(5, 9), published_at: tsOfMonth(5, 9), evolution_message_id: 'mock-evo-1' },
    ...
    social_inbox: [
      { id: 'mock-si-1', platform: 'facebook', kind: 'comment', external_id: 'mock-comment-1', thread_id: 'mock-post-1', sender_psid: null, sender_name: 'Marina Testando', original_text: 'Vocês fazem barba também?', ai_draft: 'Fazemos sim, Marina! Barba, corte e combos na Barbearia do Ju em Bragança Paulista. Chama no WhatsApp pra agendar 😊', reply_text: 'Fazemos sim, Marina! Barba, corte e combos na Barbearia do Ju em Bragança Paulista. Chama no WhatsApp pra agendar 😊', status: 'rascunho', context: { post_permalink: 'https://facebook.com/mock' }, created_at: tsOfMonth(9, 10), updated_at: tsOfMonth(9, 10), replied_at: null },
      { id: 'mock-si-2', platform: 'instagram', kind: 'message', external_id: 'mock-msg-1', thread_id: 'mock-conv-1', sender_psid: 'mock-igsid-1', sender_name: 'joao.testando', original_text: 'Qual o valor do corte?', ai_draft: 'Oi! O valor varia por serviço — dá uma olhada em www.barbeariadoju.com.br/agendar/ ou chama no WhatsApp (11) 96707-3038 que te passamos certinho!', reply_text: 'Oi! O valor varia por serviço — dá uma olhada em www.barbeariadoju.com.br/agendar/ ou chama no WhatsApp (11) 96707-3038 que te passamos certinho!', status: 'enviado', context: {}, created_at: tsOfMonth(5, 10), updated_at: tsOfMonth(5, 11), replied_at: tsOfMonth(5, 11) },
      { id: 'mock-si-3', platform: 'facebook', kind: 'comment', external_id: 'mock-comment-2', thread_id: 'mock-post-2', sender_psid: null, sender_name: 'Spam Testando', original_text: 'confira meu perfil!!', ai_draft: '', reply_text: '', status: 'rejeitado', context: {}, created_at: tsOfMonth(2, 10), updated_at: tsOfMonth(2, 10), replied_at: null },
      // DM ainda pendente: enviar mensagem direta depende da permissão pages_messaging, que
      // o app da Meta não tem (erro #3 da API). O card precisa avisar e esconder o botão.
      { id: 'mock-si-4', platform: 'instagram', kind: 'message', external_id: 'mock-msg-2', thread_id: 'mock-conv-2', sender_psid: 'mock-igsid-2', sender_name: 'Cliente Testando', original_text: 'oi, vocês abrem sábado?', ai_draft: 'Abrimos sim! Sábado das 8h às 15h.', reply_text: 'Abrimos sim! Sábado das 8h às 15h.', status: 'rascunho', context: {}, created_at: tsOfMonth(9, 12), updated_at: tsOfMonth(9, 12), replied_at: null },
    ],
