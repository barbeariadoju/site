...
// (admin-clientes.html). Ver header de admin-v15-4-core.js.
  ...
  async function confirmMerge(){
    ...
    if(!await BDJ_UX.confirm(`Mesclar ${mergeSelectedCustomer.name} em ${mergeKeepCustomer.name}? O cadastro de ${mergeSelectedCustomer.name} será apagado. Essa ação não pode ser desfeita.`))return;
