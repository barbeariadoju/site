...
-- Adiciona criação manual e remarcação segura pelo painel administrativo.

grant insert on table public.bookings to authenticated;

drop policy if exists "admin insert" on public.bookings;
create policy "admin insert" on public.bookings for insert to authenticated with check (true);
