-- Execute este arquivo no SQL Editor do Supabase para liberar horários adicionais.
-- Terça a sexta: último horário de início às 19:00.
-- Sábado: último horário de início às 15:00.
...
declare open_m integer; last_start_m integer; m integer; s time; e time;
begin
