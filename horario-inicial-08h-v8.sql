-- Execute UMA VEZ no SQL Editor do Supabase para iniciar os horários às 08:00.
-- Terça a sexta: 08:00 até 19:00. Sábado: 08:00 até 15:00.
...
begin
 ...
 open_m:=8*60; close_m:=case when extract(dow from p_date)=6 then 15*60 else 19*60 end;
 m:=open_m;
