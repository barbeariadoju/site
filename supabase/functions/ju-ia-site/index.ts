...
Deno.serve(async req=>{
 ...
 const saudacaoIsolada=(()=>{const t=normalize(message.trim());return t.length<=20&&/^(oi+|ol[aá]|bom\s*dia|boa\s*tarde|boa\s*noite|opa|e\s*a[ií]|eai|fala)\b[\s!.,?]*$/i.test(t)})()
 ...
 if(saudacaoIsolada&&semPedidoEmAberto)reply='Espero que esteja tudo bem com você! Como posso te ajudar hoje?'
