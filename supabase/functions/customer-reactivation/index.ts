...
Deno.serve(async (request: Request) => {
  ...
  // v29.21.0 — horário de silêncio (pedido do Juliano, 14/08/2026): nada de mensagem
  // proativa entre 20h e 8h (Brasília). O cron roda 14h BRT; a guarda protege disparo manual.
